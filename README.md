<!-- Для тех кому интересно как оно написанно, я вам пометил как оно работает -->
<div align="center">
    ...
    <td width="100%">
      ...
      <div align="center">
        ...
        <div style="width: 100%; background-color: #1f2937; border-radius: 10px; overflow: hidden; height: 25px; position: relative;">
          ...
          <span style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); color: white; font-weight: bold; font-size: 14px;">43% заброшен</span>
        </div>
      </div>
      <br/>
      <p align="center">
